...
/// \file SceneQuickView.h

#ifndef QRT_SceneQuickView_H
#define QRT_SceneQuickView_H
...
namespace ArcGISRuntime {
  ...
  class SceneQuickView : public QQuickFramebufferObject, public SceneView
  {
    Q_OBJECT
  ...
  public:
    explicit SceneQuickView(QQuickItem* parent = nullptr);
    explicit SceneQuickView(Scene* scene, QQuickItem* parent = nullptr);
    ~SceneQuickView();
